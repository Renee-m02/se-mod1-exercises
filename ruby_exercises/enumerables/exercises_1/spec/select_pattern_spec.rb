RSpec.describe 'select pattern' do
  ...
  it 'dinosaurs' do
    ...
    animals.each do |animal|
      dinosaurs << animal if animal.end_with?("aurus")
    end
  ...
  it 'floats' do
    ...
    floats = []
    numbers.each do |number|
      floats << number if number.integer? == false
    end
  ...
  it 'arrays' do
    ...
    elements.each do |element|
      arrays << element if element.kind_of?(Array)
    end
  ...
  it 'hashes' do
    ...
    hashes = []
    elements.each do |element|
      hashes << element if element.kind_of?(Hash)
    end
